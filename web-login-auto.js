...
const allAutoModals = [standardModal, flexModal];
...
/* ---------- Sequence: already logged in → straight to Flex/Snappi payment ---------- */
async function runSequence() {
  resetPage();
  await wait(700);

  await clickAt(myvfPayBtn);
  await wait(500); // modal slide-in — amounts are already prefilled, no SMS step needed
