...
function recomputeResult() {
  ...
  resultRate.textContent = rate.toLocaleString('el-GR', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) + '€';
  resultTotal.textContent = amount.toLocaleString('el-GR', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) + '€';
}
...
async function runSequence() {
  ...
  await wait(300);
  await dragSliderTo(amountSlider, 699);
